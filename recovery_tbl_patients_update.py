...
with open('./recovery_tbl_patients_update.sql', mode='w+', encoding='utf-8') as sql_file:
    ...
    for lf in log_files:
        with open('./logs/'+lf, mode='r', encoding='utf-8') as log_file:
            ...
            while True:
                ...
                if re.search('tbl_patients_update', current_line) is not None \
                        and re.search('tbl_patients_update_hd', current_line) is None \
